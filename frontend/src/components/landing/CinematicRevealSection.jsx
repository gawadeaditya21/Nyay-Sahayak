...
export default function CinematicRevealSection() {
  ...
  const features = [
    { title: t("landing.cinematic.features.riskMitigationTitle"), desc: t("landing.cinematic.features.riskMitigationDesc"), icon: Shield },
    { title: t("landing.cinematic.features.aiReviewTitle"), desc: t("landing.cinematic.features.aiReviewDesc"), icon: Sparkles },
    { title: t("landing.cinematic.features.legalPrecisionTitle"), desc: t("landing.cinematic.features.legalPrecisionDesc"), icon: Scale },
  ];
    ...
    <section ref={wrapperRef} className="relative h-[400vh] w-full bg-[#050505]">
      <div className="sticky top-0 h-screen w-full overflow-hidden px-4 sm:px-6">
        <div className="relative flex h-full w-full items-center justify-center" style={{ perspective: "2000px" }}>
          ...
          <div className="absolute inset-0 pointer-events-none opacity-10" style={{ backgroundImage: "linear-gradient(rgba(99,102,241,0.28) 1px, transparent 1px), linear-gradient(90deg, rgba(99,102,241,0.28) 1px, transparent 1px)", backgroundSize: "40px 40px" }} />
          <div className="pointer-events-none absolute left-1/2 top-1/2 h-[70vw] w-[70vw] max-h-[900px] max-w-[900px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-600/10 blur-[140px]" />

          <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center p-6 sm:p-8" style={{ opacity: reveal, transform: `scale(${0.82 + reveal * 0.18})` }}>
            <div className="max-w-5xl w-full text-center">
              ...
              <h2 className="text-4xl font-bold leading-tight text-white sm:text-5xl md:text-7xl font-serif">{t("landing.cinematic.headline")}</h2>
              <p className="mx-auto mt-5 max-w-2xl text-sm leading-relaxed text-slate-400 sm:mt-6 md:text-lg">{t("landing.cinematic.subcopy")}</p>
          ...
          <div className="relative" style={{ width: "clamp(320px, 78vw, 560px)", height: "clamp(420px, 72vh, 760px)", transformStyle: "preserve-3d", transform: `translate3d(0, ${docY}vh, 0) rotateZ(${docRotateZ}deg) rotateX(${docRotateX}deg) scale(${docScale})`, transformOrigin: "center center", opacity: docOpacity }}>
