  ...
  return (
    <div ref={wrapperRef} className="relative z-10 w-full bg-[var(--color-bg-main)]">
      <section className="relative flex h-screen flex-col items-center justify-center overflow-hidden px-6">
        <div className="pointer-events-none absolute left-1/2 top-1/2 h-[60vw] w-[60vw] max-w-225 max-h-225 -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-600/10 blur-[120px]" />
        ...
        <div className="relative z-10 mb-12 max-w-3xl shrink-0 text-center">
          ...
          <h2 ref={headerTitleRef} className="mb-5 text-3xl font-bold leading-tight text-[var(--color-text-main)] md:text-5xl lg:text-6xl font-serif">
        ...
        <div className="relative mx-auto flex h-80 w-full max-w-2xl items-center justify-center shrink-0" style={{ perspective: '1000px' }}>
          <div ref={doc1Ref} className="absolute z-10 flex aspect-3/4 w-28 flex-col rounded-2xl border border-[var(--color-border-main)] bg-[var(--color-bg-surface)] p-3 shadow-2xl backdrop-blur-md md:w-36 md:p-4">
          ...
          <div ref={doc2Ref} className="absolute z-10 flex h-16 w-32 rounded-xl border border-[var(--color-border-main)] bg-[var(--color-bg-surface)] p-2.5 shadow-2xl backdrop-blur-md md:h-18 md:w-36 md:p-3">
          ...
          <div ref={doc3Ref} className="absolute z-10 flex aspect-3/4 w-28 flex-col rounded-2xl border border-[var(--color-border-main)] bg-[var(--color-bg-surface)] p-3 shadow-2xl backdrop-blur-md md:w-36 md:p-4">
          ...
          <div ref={hubRef} className="relative z-20 flex h-36 w-36 items-center justify-center overflow-hidden rounded-3xl border border-indigo-500/30 bg-[var(--color-bg-surface)] shadow-[0_0_50px_rgba(79,70,229,0.15)] backdrop-blur-xl md:h-44 md:w-44">
            ...
            <div ref={laserRef} className="absolute left-0 right-0 z-30 h-0.75 bg-indigo-400" style={{ top: '-10%', opacity: 0, boxShadow: '0 0 20px 5px rgba(99,102,241,0.5), 0 0 40px 10px rgba(99,102,241,0.2)' }} />
          </div>
        ...
        <div ref={ctaRef} className="relative z-10 mt-8 shrink-0">
          <button onClick={() => (window.location.href = '/chat')} className="group inline-flex items-center gap-4 rounded-full bg-white px-8 py-4 text-base font-bold text-[#050505] transition-colors hover:bg-indigo-50 md:text-lg">
            ...
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[var(--color-bg-main)] text-[var(--color-text-main)] transition-transform group-hover:translate-x-1">
              <ArrowRight size={14} />
            </span>
          </button>
        </div>
