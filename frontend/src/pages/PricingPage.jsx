        ...
        <div className="min-h-screen bg-gray-50 flex flex-col items-center py-16 px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl w-full">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-8 flex flex-col">
                    ...
                    <div className="mt-6 text-5xl font-extrabold text-gray-900">$0<span className="text-xl font-medium text-gray-500">/mo</span></div>
                ...
                <div className="bg-white border-2 border-indigo-600 rounded-2xl shadow-lg p-8 flex flex-col relative transform md:-translate-y-4">
                    ...
                    <div className="mt-6 text-5xl font-extrabold text-gray-900">$9.99<span className="text-xl font-medium text-gray-500">/mo</span></div>
                    <ul className="mt-8 space-y-4 flex-1">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-8 flex flex-col">
                    ...
                    <div className="mt-6 text-5xl font-extrabold text-gray-900">$29.99<span className="text-xl font-medium text-gray-500">/mo</span></div>
                    <ul className="mt-8 space-y-4 flex-1">
